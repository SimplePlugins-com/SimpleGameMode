...
public class CreativeCommand extends BukkitCommand {
    private final ConfigurationSection section;

    public CreativeCommand(@NotNull String name, @NotNull ConfigurationSection section) {
        super(name);
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String label, @NotNull String[] args) {
        ...
        sender.sendMessage(config.getMessage("gamemode_creative"));
        return true;
    }
}